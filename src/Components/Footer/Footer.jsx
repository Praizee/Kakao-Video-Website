...
const Footer = () => {
  ...
  return (
    <div className="bg-[black] text-white ">
      <footer className="footer laptop:p-10 laptop:pt-20 p-6 max-w-[90%] laptop:mx-[5.7rem] mx-0">
        <div className="laptop:-mr-[9rem] laptop:-ml-10">
          ...
          <div className="tablet:hidde laptop:min-w-[26rem] tablet:min-w-[19rem] laptop:block">
            <span className="text-[0.85rem] text-white font-medium laptop:mb-4">
              <p className="">
                /VIDEO CREATORS
              </p>
            </span>
        ...
        <div className="footer uppercase text-white/50">
          <div className="laptop:ml-[rem] mb-8 laptop:mb-0 tablet:mb-0">
            <span className="text-[0.85rem] text-white font-medium laptop:mb-4">/NAVIGATION</span>
          ...
          <div>
            <span className="text-[0.85rem] text-white font-medium laptop:mb-4">/OUR WORKS</span>
          ...
          <div>
            <span className="text-[0.85rem] text-white font-medium laptop:mb-4">/SOCIALS</span>
            <a className="link link-hover font-normal leading-[1.6rem]">Style Guide</a>
            <a className="link link-hover font-normal leading-[1.6rem]">Instructions</a>
            <a className="link link-hover font-normal leading-[1.6rem]">Licenses</a>
            <a className="link link-hover font-normal">Changelog</a>
      ...
      <footer className="footer mx-2 laptop:p-0 laptop:py-16 p-6 max-w-[90%] laptop:mx-[5.6rem] border border-white/25 border-x-transparent">
        ...
        <div className="footer">
          <div className="relative w-full border justify-between border-x-transparent border-t-transparent border-white/25">
            <p className="mt-2 text-[1rem] font-normal leading-[1.6rem] laptop:mt-5">
              Get in touch with our team. Contact Us and let's create something extraordinary.
            </p>
            <input
              type="email"
